...
class GoogleDriveService:
    ...
    def get_all_files_recursive(self, folder_id: str, file_types: List[str] = None) -> List[Dict]:
        ...
        if file_types is None:
            file_types = ['application/pdf', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/msword', 'application/vnd.oasis.opendocument.text', 'application/zip', 'application/xml', 'text/xml', 'message/rfc822']
